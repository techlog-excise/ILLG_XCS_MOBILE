...
class FloatButtonDialog extends StatefulWidget {
  FloatButtonDialog({this.Current});
  final DateTime Current;
  @override
  _FloatButtonDialogState createState() => _FloatButtonDialogState();
}
class _FloatButtonDialogState extends State<FloatButtonDialog> with TickerProviderStateMixin {
  int _angle = 90;
