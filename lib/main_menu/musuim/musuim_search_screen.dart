...
class MusuimSearchScreenFragment extends StatefulWidget {
  @override
  _FragmentState createState() => new _FragmentState();
}
class _FragmentState extends State<MusuimSearchScreenFragment> {
  TextEditingController controller = new TextEditingController();
  List<ItemsMusuimMain> _searchResult = [];
  List<ItemsMusuimMain> _itemsInit = [
    new ItemsMusuimMain(
        new ItemsMusuimApprove(
        "กค 0809.1/2561",
        "09 กันยายน 2561",
        "เวลา 13.00 น.",
        "นายนิรมิตร เนตรนัย",
              ...
              Column(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Text("เลขที่หนังสือเห็นชอบ", style: textLabelStyle,),
                  ),
                  Padding(
                  ...
                  Container(
                    padding: paddingLabel,
                    child: Text("ผู้จัดเก็บ", style: textLabelStyle,),
                  ),
                  Padding(
                    padding: paddingInputBox,
                    child: Text(
                      _searchResult[index].Musuims.MusuimPerson,
                      style: textInputStyle,),
                  ),
                ],
              ),
  ...
  _navigate(BuildContext context, ItemsMusuimMain itemMain, IsEdit,
                ...
                /*child: Row(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: new Text('ILG60_B_07_00_02_00',
