...
class _FragmentState extends State<AuctionMainScreenFragment> with TickerProviderStateMixin {
  ...
  void _setDataSaved() {
    ...
    if (choices.length == 2) {
      ...
      //เพิ่ม item forms
      itemsFormsTab.add(new ItemsDestroyForms("บัญชีรายการขายของกลาง"));
    }
    tabController = TabController(length: choices.length, vsync: this);
    _tabPageSelector = new TabPageSelector(controller: tabController);
  }
  ...
  void onSaved(BuildContext mContext) async {
    if (editApproveNumber.text.isEmpty || editApproveYear.text.isEmpty) {
      ...
      new VerifyDialog(mContext, 'กรุณากรอกข้อมูลผู้เสนออนุมัติ');
    } else if (editPersonConsider.text.isEmpty || editConsiderDepartment.text.isEmpty) {
      new VerifyDialog(mContext, 'กรุณากรอกข้อมูลผู้พิจารณาอนุมัติ');
      ...
      new VerifyDialog(mContext, 'กรุณากรอกข้อมูลประธานขายของกลาง');
    } else {
      if (_onEdited) {
        showDialog(
            barrierDismissible: false,
  ...
  Future<bool> onLoadActionInsAllEvidenceOut() async {
    ...
    Map map_evidence = {
      ...
      "EVIDENCE_OUT_TYPE": 3,
      "EVIDENCE_OUT_NO": "กค." + editApproveNumber.text + "/" + editApproveYear.text,
      "EVIDENCE_OUT_NO_DATE": _dtOfferDate.toString(),
      "BOOK_NO": "",
      "RECEIPT_NO": "",
      "PAY_DATE": "",
      "APPROVE_DATE": _dtConsiderDate.toString(),
      "RETURN_DATE": "",
      "REMARK": "",
      "APPROVE_NO": "",
      "IS_ACTIVE": "1",
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: TextField(
                              ...
                              onTap: () {
                                FocusScope.of(context).requestFocus(new FocusNode());
                                _navigateSearchStaff(context, 69);
                              },
                          ...
                          Padding(
                            ...
                            child: TextField(
                              ...
                              onTap: () {
                                FocusScope.of(context).requestFocus(new FocusNode());
                                _navigateSearchStaff(context, 70);
                              },
                              style: textInputStyle,
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Text(
                            /*"วันที่จัดเก็บ"*/ "วันที่ขายของกลาง",
                            style: textLabelStyle,
                          ),
                          Text(
                            "*",
                        ...
                        children: <Widget>[
                          new Container(
                            ...
                            child: TextField(
                              ...
                              onTap: () {
                                FocusScope.of(context).requestFocus(new FocusNode());
                                _navigateSearchStaff(context, 71);
                              },
...
//************************end_tab_3*******************************
  ...
  void add_staff_to(int CONTRIBUTOR_ID) {
    /*69=ผู้เสนออนุมัติขายทอดตลาด
      70=ผู้พิจารณาอนุมัติขายทอดตลาด
      71=ประธานฯขายของกลาง*/
  ...
  _navigateSearchStaff(BuildContext context, int CONTRIBUTOR_ID) async {
    ...
    if (result.toString() != "back") {
      ...
      //ประธานฯขายของกลาง
      editDesployPerson.text = get_staff_name(itemsListEvidenceStaff, 71);
      editDesployDepartment.text = get_office_name(itemsListEvidenceStaff, 71);

      //ผู้เสนออนุมัติขายทอดตลาด
      editPersonOffer.text = get_staff_name(itemsListEvidenceStaff, 69);
      editOfferDepartment.text = get_office_name(itemsListEvidenceStaff, 69);

      //ผผู้พิจารณาอนุมัติขายทอดตลาด
      editPersonConsider.text = get_staff_name(itemsListEvidenceStaff, 70);
      editConsiderDepartment.text = get_office_name(itemsListEvidenceStaff, 70);
    }
  }
