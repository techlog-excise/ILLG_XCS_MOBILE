...
class AuctionMainScreenFragmentSearchResult extends StatefulWidget {
  // ItemsPersonInformation ItemsPerson;
  ItemsOAGMasStaff ItemsPerson;
  List<ItemsEvidenceOutList> ItemSearch;
  AuctionMainScreenFragmentSearchResult({
    Key key,
...
class _FragmentState extends State<AuctionMainScreenFragmentSearchResult> {
