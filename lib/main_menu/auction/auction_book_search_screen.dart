...
import 'package:prototype_app_pang/main_menu/auction/select_book_select_evidence_screen.dart';

class AuctionBookSearchScreenFragment extends StatefulWidget {
  @override
  _FragmentState createState() => new _FragmentState();
}
class _FragmentState extends State<AuctionBookSearchScreenFragment> {
  ...
  _navigate(BuildContext context) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => SelectAuctionBookScreenFragment()),
    );
