...
class AuctionSearchScreenFragment extends StatefulWidget {
  @override
  _FragmentState createState() => new _FragmentState();
}
class _FragmentState extends State<AuctionSearchScreenFragment> {
  TextEditingController controller = new TextEditingController();
  List<ItemsAuctionMain> _searchResult = [];
  List<ItemsAuctionMain> _itemsInit = [
    new ItemsAuctionMain(
        new ItemsApprove(
            "กค 0809.1/2561",
            "09 กันยายน 2561",
            "เวลา 13.00 น.",
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: paddingInputBox,
                    child: Text(
                      _searchResult[index].Approves.PersonOffer,
                      style: textInputStyle,),
                  ),
                ],
              ),
  ...
  _navigate(BuildContext context, ItemsAuctionMain itemMain, IsEdit,
                ...
                /*child: Row(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: new Text('ILG60_B_08_00_02_00',
