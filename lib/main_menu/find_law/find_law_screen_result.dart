...
class FindLawScreenResult extends StatefulWidget {
  ...
  @override
  _FindLawScreenResult createState() => new _FindLawScreenResult();
}

class _FindLawScreenResult extends State<FindLawScreenResult> {
  ...
  _navigateSelection(BuildContext context, String title, ItemsMasLawGroupSubSection item) async {
    ...
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => FindLawScreenResultData(
          ItemsData: item,
          Title: title,
        ),
      ),
