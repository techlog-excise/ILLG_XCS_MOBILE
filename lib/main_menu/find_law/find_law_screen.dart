...
class FindLawScreen extends StatefulWidget {
  @override
  _FindLawScreen createState() => new _FindLawScreen();
}

class _FindLawScreen extends State<FindLawScreen> {
  ...
  _navigateSearch(BuildContext mContext) async {
    ...
    if (_searchResult.length == 0) {
      ...
      final result = await Navigator.push(
        mContext,
        MaterialPageRoute(
            builder: (context) => FindLawScreenResult(
