class ItemsWarehouseCase {
  List<ItemsWarehouseList> RESPONSE_DATA;
  ItemsWarehouseCase({
    this.RESPONSE_DATA
  });
  factory ItemsWarehouseCase.fromJson(Map<String, dynamic> json) {
    return ItemsWarehouseCase(
      RESPONSE_DATA: List.from(
            json['RESPONSE_DATA'].map((m) =>
                ItemsWarehouseList.fromJson(m))),
    );
  }
}

class ItemsWarehouseList {
  ...
  factory ItemsWarehouseList.fromJson(Map<String, dynamic> json) {
    return ItemsWarehouseList(
