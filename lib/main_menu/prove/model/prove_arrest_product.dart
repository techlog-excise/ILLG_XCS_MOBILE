...
import 'package:prototype_app_pang/main_menu/prove/model/prove_arrest_product_controller.dart';

class ItemsProveArrestProduct {
  ...
  bool IS_CHECK;
  ItemsProveArrestProductController controller;
  List<ItemsListDocument> itemsListDocument;

  ItemsProveArrestProduct({
    this.PRODUCT_ID,
    this.ARREST_ID,
  ...
  factory ItemsProveArrestProduct.fromJson(Map<String, dynamic> json) {
    return ItemsProveArrestProduct(
        ...
        IS_PROVE: false,
        IS_CHECK: false,
        controller: new ItemsProveArrestProductController(
