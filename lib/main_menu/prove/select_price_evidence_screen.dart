...
class SelectPriceBookScreenFragment extends StatefulWidget {
  bool IsUpdate;
  List<EvidenceInventoryList> itemsEvidenceItem;
  SelectPriceBookScreenFragment({
    Key key,
...
class _FragmentState extends State<SelectPriceBookScreenFragment> {
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(_itemsInit[index].EVIDENCE_IN_ITEM_CODE.toString(), style: textInputStyle,),
                    ),
                    Container(
                      padding: paddingLabel,
                    ...
                    Padding(
                      padding: paddingInputBox,
                      child: Text(_itemsInit[index].PRODUCT_DESC.toString(), style: textInputStyle,),
                    ),
                  ],
                ),
                Align(
  ...
  Widget build(BuildContext context) {
    ...
    return new WillPopScope(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: new Text("เลือกราคาขายปลีก",
