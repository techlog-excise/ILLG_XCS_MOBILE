...
class _FragmentState extends State<ExportMainScreenFragment> with TickerProviderStateMixin {
  ...
  String _currentOfferDate, _currentConsiderDate, _currentDestroyDate, _currentReturnDate, _currentOfferTime, _currentConsiderTime, _currentDestroyTime;
  var dateFormatDate, dateFormatTime, _dtOfferDate, _dtConsiderDate, _dtReturnDate, _dtDestroyDate;
  ...
  void _setDataSaved() {
    ...
    if (choices.length == 2) {
      ...
      //เพิ่ม item forms
      itemsFormsTab.add(new ItemsDestroyForms("บันทึกรับมอบของกลางจากคณะกรรมการเก็บรักษาของกลาง (ขก.3)"));
    }
    tabController = TabController(length: choices.length, vsync: this);
    _tabPageSelector = new TabPageSelector(controller: tabController);
  }
  ...
  void onSaved() async {
    ...
    setState(() {
      ...
      if (_exportType1) {
        ...
        exportType = 1;
        approve = new ItemsExportApprove(editApproveNumber.text, editOfferDate.text, editOfferTime.text, editPerson.text, editDepartment.text, editPersonConsider.text, editConsiderDepartment.text, editConsiderDate.text, editConsiderTime.text, editStock.text, editExportComment.text, exportType, null,
            new ItemsDonate(editDonorPerson.text, editDonorPosition.text, editDonorDepartment.text));
      }

      ItemsExport export = ItemsExport(editExportNumber.text, editExportDate.text, editExportTime.text, editExportPerson.text, editExportDepartment.text, itemEvidence);
                                          ...
                                          child: TextField(
                                            onTap: () {
                                              showDialog(
                                                  context: context,
                                                  builder: (BuildContext context) {
                                                    return DynamicDialog(Current: _dtReturnDate);
                                                  }).then((s) {
                                                String date = "";
                                                List splits = dateFormatDate.format(s).toString().split(" ");
                                                date = splits[0] + " " + splits[1] + " " + (int.parse(splits[3]) + 543).toString();
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              padding: paddingInputBox,
                              child: Text(
                                itemMain.Approves.ExportType == 0 ? "ใช้ทางราชการ" : "บริจาค",
                                style: textInputStyle,
                              ),
                            ),
                            Container(
                                ...
                                ? Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        padding: paddingLabel,
                                        child: Text(
                                          itemMain.Approves.Governments.ReturnDate,
                                          style: textInputStyle,
                                        ),
                                      ),
                                      Container(
                                ...
                                : Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        padding: paddingInputBox,
                                        child: Text(
                                          itemMain.Approves.Donates.DonorPosition,
                                          style: textInputStyle,
                                        ),
                                      ),
                                      Container(
                                      ...
                                      Padding(
                                        padding: paddingInputBox,
                                        child: Text(
                                          itemMain.Approves.Donates.DonorDepartment,
                                          style: textInputStyle,
                                        ),
                                      ),
                                      Container(
...
//************************end_tab_1*******************************
  ...
  navigateDeliveredBook(BuildContext context) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => ExportBookSearchScreenFragment()),
    );
  ...
  Widget _buildContent_tab_2() {
    ...
    Widget _buildContent_saved(BuildContext context) {
      ...
      Widget _buildExpandableContent(int index) {
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    padding: paddingInputBox,
                    child: Text(
                      itemMain.Exports.Evidences[index].ProductGroup + ' / ' + itemMain.Exports.Evidences[index].MainBrand,
                      style: textInputStyle,
                    ),
                  ),
                  SingleChildScrollView(
        ...
        return ExpandableNotifier(
          controller: itemMain.Exports.Evidences[index].EvidenceDetailController.expController,
          child: Stack(
            children: <Widget>[
              Expandable(collapsed: _buildCollapsed(index), expanded: _buildExpanded(index)),
              Align(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: paddingInputBox,
                    child: Text(
                      itemMain.Exports.ExportDate + " " + itemMain.Exports.ExportTime,
                      style: textInputStyle,
                    ),
                  ),
                  Container(
