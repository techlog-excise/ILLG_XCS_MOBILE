class ItemsListArrestIndictmentProductEdit {
  int PRODUCT_ID;
  ...
  ItemsListArrestIndictmentProductEdit({
    this.PRODUCT_ID,
  ...
  factory ItemsListArrestIndictmentProductEdit.fromJson(Map<String, dynamic> js) {
    return ItemsListArrestIndictmentProductEdit(
