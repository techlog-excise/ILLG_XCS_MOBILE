...
class _FragmentState extends State<TranferMainScreenFragmentSearchResult> {
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        _searchResult[index].EvidenceOutStaff.forEach((f) {
          ...
          staff_name = "นาย" + f.FIRST_NAME.toString() + " " + f.LAST_NAME.toString();
          //}
        });
