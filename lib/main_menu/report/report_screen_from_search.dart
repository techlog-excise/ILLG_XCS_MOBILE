...
class ReportMainFromSearchScreenFragment extends StatefulWidget {
  final String START_DATE;
  final String END_DATE;
  ReportMainFromSearchScreenFragment({
    Key key,
...
class _FragmentState extends State<ReportMainFromSearchScreenFragment>  with TickerProviderStateMixin {
